...
def play_game(screen, username):
    ...
    # load assets
    image_background = pygame.image.load(r'C:\Users\amang\OneDrive\Рабочий стол\pp hw\TSIS\Task3\assets/AnimatedStreet.png')
    image_player     = pygame.image.load(r'C:\Users\amang\OneDrive\Рабочий стол\pp hw\TSIS\Task3\assets/Player.png')
    image_enemy      = pygame.image.load(r'C:\Users\amang\OneDrive\Рабочий стол\pp hw\TSIS\Task3\assets/Enemy.png')
    coin_image       = pygame.image.load(r'C:\Users\amang\OneDrive\Рабочий стол\pp hw\TSIS\Task3\assets/dollar.png').convert_alpha()

    if settings.get("sound", True):
        pygame.mixer.music.load(r'C:\Users\amang\OneDrive\Рабочий стол\pp hw\TSIS\Task3\assets/background.wav')
        pygame.mixer.music.play(-1)
    else:
        pygame.mixer.music.stop()
    sound_crash = pygame.mixer.Sound(r'C:\Users\amang\OneDrive\Рабочий стол\pp hw\TSIS\Task3\assets/crash.wav')
